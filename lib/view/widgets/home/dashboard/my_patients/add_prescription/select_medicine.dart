...
class SelectMedicine extends StatelessWidget {
    ...
    return Container(
      ...
      child: Column(
        children: [
          GestureDetector(
            onTap: () {
              TextEditingController medicineNameCon = TextEditingController();
              Get.bottomSheet(
                    ...
                    return Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          CustomTextFormField(
                            textEditingController: medicineNameCon,
                                    ...
                                    child: ListTile(
                                      onTap: () {
                                        ...
                                        controller.medicines.add({
                                          'drug_name': dropDownItemModel.label,
                                          'qty': '1',
                                          'days': '1',
                                          'time': '',
                                          'type': '',

...
class AppointmentsList extends StatelessWidget {
      ...
      child: ListView(
        ...
        children: [
          GetBuilder<AppointmentController>(
            builder: (controller) {
              if (controller.sessions.isEmpty || (controller.sessions.length == 1 && controller.sessions[0].tokenDetails!.isEmpty)) {
                return Center(
                  child: Column(
                    children: [
                      SizedBox(
                      ...
                      SizedBox(height: 10),
                      if (controller.nextAvailable == null)  Column(
                        children: [
                          SizedBox(height: 05),
                          CustomButton(
                            function: () {
                            ...
                            text: 'Notify me of next available appointment',
                          ),
                        ],
                      ),
                        ...
                        SizedBox(
                          ...
                          child: Column(
                            children: [
                              ...
                              InkWell(
                                onTap: () async {
                                  controller.appointmentDate = extractDate(controller.nextAvailable.toString()).toString();
                                  controller.selectedSessionIndex = null;
                                  controller.selectedTokenIndex = null;
                                  await controller.checkAvailableTimes();
                                },
                                child: Container(
                                  width: 300,
                                  height: 39,
                      ...
                      SizedBox(
                        height: controller.nextAvailable == null ? AppDecoration().screenHeight * 0.25 : AppDecoration().screenHeight * 0.2,
                      ),
                    ],
                  ),
                );
                ...
                return SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, sessionIndex) {
                      if (controller.sessions[sessionIndex].tokenDetails!.isEmpty) {
                          ...
                          builder: (_) {
                            return FittedBox(
                              child: GestureDetector(
                                onTap: () {
                                  controller.selectedSessionIndex = sessionIndex;
                                  controller.selectedTokenIndex = null;
                                  controller.update();
                                },
                                child: AnimatedContainer(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    color: controller.selectedSessionIndex == sessionIndex ? AppColors.primaryColor : AppColors.secondaryColor,
                                  ),
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      fontFamily: AppDecoration.cairo,
                                      fontWeight: FontWeight.w400,
                                      color: controller.selectedSessionIndex == sessionIndex ? AppColors.secondaryColor : AppColors.grey,
                ...
                return Column(
                  ...
                  children: [
                    ...
                    GridView.builder(
                      ...
                      itemCount: controller.sessions[controller.selectedSessionIndex!].tokenDetails!.length,
                      itemBuilder: (context, index) {
                        TokenDetailsModel tokenDetailsModel = controller.sessions[controller.selectedSessionIndex!].tokenDetails![index];
  ...
  DateTime extractDate(String input) {
    // Define the regular expression to extract the date part
    RegExp dateExp = RegExp(r'\d{2}-\d{2}-\d{4}');
    // Find the match in the input string
    Match? match = dateExp.firstMatch(input);
    ...
    if (match != null) {
      ...
      throw FormatException("Date not found in input string");
    }
  }

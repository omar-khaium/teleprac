...
class PrescriptionDetailsScreen extends StatelessWidget {
  const PrescriptionDetailsScreen({
    super.key,
    required this.advancedPrescriptionModel,
  });
  final AdvancedPrescriptionModel advancedPrescriptionModel;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: CustomContainer(
        ...
        children: [
          const UpperPart(
            text: AppTexts.prescriptionDetails,
          ),
          Container(
                ...
                Column(
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Text(
                        advancedPrescriptionModel
                            .prescriptionView!.patientAddress!,
                        style: TextStyle(
                          fontSize: AppDecoration().screenWidth * 0.04,
                          color: AppColors.secondaryColor,
                        ),
                ...
                Column(
                  children: [
                    ...
                    SizedBox(
                      width: AppDecoration().screenWidth * 0.4,
                      child: Text(
                        advancedPrescriptionModel.prescriptionView!.doctorName!,
                        style: TextStyle(
                          fontSize: AppDecoration().screenWidth * 0.04,
                          color: AppColors.secondaryColor,
                        ),
                    ...
                    SizedBox(
                      ...
                      child: Text(
                        advancedPrescriptionModel
                            .prescriptionView!.doctorAddress!,
                        style: TextStyle(
                          fontSize: AppDecoration().screenWidth * 0.04,
                          color: AppColors.secondaryColor,
                        ),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    advancedPrescriptionModel.createdDate!,
                    style: TextStyle(
                      fontSize: AppDecoration().screenWidth * 0.05,
                      fontWeight: FontWeight.bold,
                    ),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    advancedPrescriptionModel.registrationNumber!,
                    style: TextStyle(
                      fontSize: AppDecoration().screenWidth * 0.05,
                      fontWeight: FontWeight.bold,
                    ),
            ...
            child: Row(
              ...
              children: [
                Expanded(
                  flex: 2,
                  child: Text(
                    'Chief Complaints :\n\t\t${advancedPrescriptionModel.prescriptionView!.chiefComplaints!}',
                    style: TextStyle(
                      fontSize: AppDecoration().screenWidth * 0.05,
                      fontWeight: FontWeight.bold,
                    ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...List.generate(
                  advancedPrescriptionModel.itemDetails!.length,
                  (index) {
                    return Padding(
                      ...
                      child: Column(
                        children: [
                          Row(
                            children: [
                              SizedBox(
                                width: AppDecoration().screenWidth * 0.23,
                                child: Text(
                                  advancedPrescriptionModel
                                          .itemDetails![index].drugName ??
                                      '',
                                  style: TextStyle(
                                    fontSize:
                              ...
                              SizedBox(
                                  width: AppDecoration().screenWidth * 0.02),
                              SizedBox(
                                width: AppDecoration().screenWidth * 0.1,
                                child: Text(
                                  advancedPrescriptionModel
                                          .itemDetails![index].qty ??
                                      '',
                                  style: TextStyle(
                                    fontSize:
                                        AppDecoration().screenWidth * 0.04,
                          ...
                          if (advancedPrescriptionModel.itemDetails!.length !=
                              index + 1)
                    ...
                    children: [
                      Container(
                        ...
                        child: CachedNetworkImage(
                          imageUrl: advancedPrescriptionModel
                              .prescriptionView!.signatureImage!,
                          width: AppDecoration().screenWidth * 0.3,
                      ...
                      Text(
                        'Dr. ${advancedPrescriptionModel.prescriptionView!.doctorName!}',
                        style: TextStyle(
